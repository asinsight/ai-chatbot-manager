...
- **`features/`** — 마일스톤별 feature plan MD. 각 feature 브랜치 시작 시 작성. 현재: `M0_admin_skeleton.md`, `M1_env_connections.md`, `M2_prompt_editor.md`, `M3_character_crud.md`, `M4_image_config.md`, `M5_workflows_logs.md`, `M6_lorebook.md`.
